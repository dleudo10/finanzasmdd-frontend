...
import WarehouseFormDelete from '../form/WarehouseFormDelete';

const WarehouseDeleteCard = () => {
                ...
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Esta acción ocultará la bodega y no podrá usarse hasta reactivarla.
                        </p>
                    </div>
...
export default WarehouseDeleteCard
