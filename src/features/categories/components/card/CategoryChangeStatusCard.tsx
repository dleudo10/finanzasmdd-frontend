...
import CategoryFormChangeStatus from '../form/CategoryFormChangeStatus';
...
const CategoryChangeStatusCard = ({ is_active }: StateProps) => {
                ...
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Esta categoria esta actualmente {is_active ? "activa" : "inactiva"}.
                        </p>
                    </div>
...
export default CategoryChangeStatusCard
